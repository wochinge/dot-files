# Generated by Powerlevel10k configuration wizard on 2019-10-24 at 23:48 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_ICON='\uFb26 '
  POWERLEVEL9K_VCS_BRANCH_ICON=${(g::)POWERLEVEL9K_PROMPT_ICON}
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='${(g::)POWERLEVEL9K_PROMPT_ICON}'
